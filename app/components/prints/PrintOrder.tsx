...
class PrintOrder extends Component {
  ...
  render() {
    const {orderInfo, itemList, transactionInfo} = this.props;
    return (
    <>
      <div style={{padding: '5%', color: '#0a0a0a', fontSize: '12px'}}>
        ...
        <div>
            Paid by customer:  <NumberFormat value={transactionInfo.paid_amount} displayType={'text'}
                                             thousandSeparator={true} thousandsGroupStyle="lakh"
                                             decimalScale={2}/>
        </div>

        <div>
          Total cost: <NumberFormat value={orderInfo.total_cost} displayType={'text'}
                                    thousandSeparator={true} thousandsGroupStyle="lakh"/>
        </div>
        ...
        <div>
            Discount:  <NumberFormat value={transactionInfo.discount} displayType='text'
                                     thousandSeparator={true} thousandsGroupStyle='lakh'
                                     decimalScale={2} />
        </div>
